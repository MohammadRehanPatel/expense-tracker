...
public interface ExpenseServiceFeignClient {
    ...
    ResponseEntity<ExpenseCategory> createExpCat(
            @PathVariable String userId,
            @RequestBody ExpCatRequest expCatRequest
    );

    @GetMapping("/users/{userId}/categories/{expCatId}")
    ResponseEntity<ExpenseCategory> getExpCatById(
            @PathVariable String userId,
            @PathVariable String expCatId
    );

    @GetMapping("/users/{userId}/categories/")
    ResponseEntity<List<ExpenseCategory>> listExpCatByUserId(
            @PathVariable String userId
    );


    @PutMapping("/users/{userId}/categories/{expCatId}")
    ResponseEntity<ExpenseCategory> updateExpCat(
            @PathVariable String userId,
            @PathVariable String expCatId,
            @RequestBody ExpCatRequest expCatRequest
    );
    @DeleteMapping("/users/{userId}/categories/{expCatId}")
    ResponseEntity<Void> deleteExpCatById(
            @PathVariable String userId,
            @PathVariable String expCatId
    );
    ...
    ResponseEntity<Expense> getExpById(
            @PathVariable String userId,
            @PathVariable String expId
    );

    @GetMapping("/users/{userId}/expenses/")
    ResponseEntity<Page<Expense>> listExpByUserId(
            @PathVariable String userId,
            Pageable pageable,
    ...
    ResponseEntity<Void> deleteExpById(
            @PathVariable String userId,
            @PathVariable String expId
    );
